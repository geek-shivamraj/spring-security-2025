...
/**
 * Refer this for Setting up the Authorization Server: https://docs.spring.io/spring-authorization-server/reference/getting-started.html
 * Refer this for OpenID Config: http://localhost:9000/.well-known/openid-configuration
 */
@Configuration
@EnableWebSecurity
